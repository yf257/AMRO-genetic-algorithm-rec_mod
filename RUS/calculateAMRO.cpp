...
calculateAMRO::calculateAMRO(double *data, double * param, Ipp64f * theta, int cdev, int gridN,int dataLeng,Ipp64f * phi)
{
	...
	nPoints = 4*Fermi->nPoints;
	//cout << nPoints << endl;
	starts = new Ipp64f[nPoints * 3];
	circum = new Ipp64f[nPoints];
	...
	tempfunc = new Ipp64f[16 * nPoints];
	...
	minDos = 0;
    maxDos = 0;
	temp = new Ipp64f[10 * nPoints];
	upper_bound = new Ipp64f[nPoints];
		...
		for (int th = 0; th < _dataLeng; th++) {
			...
			for (int i = 1; i < steps; i++) {
				...
				*/
				...
				taufundos(params, minDos, maxDos, argx, argy, argz, nPoints, tempx, taus, ones);// calculate k dependent tau
			...
			taufundos(params, minDos, maxDos, argx, argy, argz, nPoints, tempx, taus, ones);// calculate k dependent tau for last point
...
int calculateAMRO::func(Ipp64f *params, Ipp64f * kz, Ipp64f * kx, Ipp64f * ky, int length, Ipp64f *temp, Ipp64f *out) {
...
int calculateAMRO::veloXsub(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f *out)
{
...
int calculateAMRO::veloYsub(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f *out) {
...
int calculateAMRO::veloZsub(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f *out) {
	ippsMulC_64f(kx, 3.74767, temp, length); //term for long complicated kz term, param6
	vdCos(length, temp, &temp[2 * length]); // cos kx
	ippsMulC_64f(ky, 3.74767, temp, length);
	vdCos(length, temp, &temp[4 * length]); // cos ky
...
int calculateAMRO::veloX(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f* tempvel, Ipp64f *out) {
	...
	ippsAddC_64f_I(params[9 - 1] * params[9 - 1] * (-35164.83516)*(-35164.83516), &tempvel[8 * length], length);//4*delta^2+(e-ePi)^2
...
int calculateAMRO::veloY(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f* tempvel, Ipp64f *out) {
...
int calculateAMRO::veloZ(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f* tempvel, Ipp64f *out) {
...
int calculateAMRO::funcD(Ipp64f *params, Ipp64f * kz, Ipp64f * kx, Ipp64f * ky, int length, Ipp64f *temp, Ipp64f *out) {
...
int calculateAMRO::veloXsubD(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f *out)
{
	ippsMulC_64f(kx, 3.74767, temp, length); //term for sin(kx), param3
	vdSin(length, temp, &temp[1 * length]);
	ippsMulC_64f(&temp[1 * length], params[3 - 1] * 11.4215, out, length);
...
int calculateAMRO::veloYsubD(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f *out) {
	ippsMulC_64f(ky, 3.74767, temp, length); //term for sin(ky), param3
	vdSin(length, temp, &temp[1 * length]);
	ippsMulC_64f(&temp[1 * length], params[3 - 1] * 11.4215, out, length);
...
int calculateAMRO::veloZsubD(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f *out) {
	ippsMulC_64f(kx, 3.74767, temp, length); //term for long complicated kz term, param6
	vdCos(length, temp, &temp[2 * length]); // cos kx
	ippsMulC_64f(ky, 3.74767, temp, length);
	vdCos(length, temp, &temp[4 * length]); // cos ky
...
int calculateAMRO::veloXD(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f* tempvel, Ipp64f *out) {
...
int calculateAMRO::veloYD(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f* tempvel, Ipp64f *out) {
...
int calculateAMRO::veloZD(Ipp64f *params, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f* tempvel, Ipp64f *out) {
...
int calculateAMRO::taufundos(Ipp64f *params, Ipp64f minDos, Ipp64f maxDos, Ipp64f *kx, Ipp64f *ky, Ipp64f *kz, int length, Ipp64f *temp, Ipp64f *out, Ipp64f *ones) {
	veloXD(params, kx, ky, kz, length, &temp[3 * length], &temp[4 * length], temp); //calculate velocities;
	veloYD(params, kx, ky, kz, length, &temp[3 * length], &temp[4 * length], &temp[length]);
	veloZD(params, kx, ky, kz, length, &temp[3 * length], &temp[4 * length], &temp[2 * length]);
	...
	ippsMulC_64f_I(0, &temp[3 * length], length);
