...
double GeneticAlgorithm::calculateResidual(Parameters::fitParameters * parameters, int threadID){
	...
	//	std::cout << "invalid P" << std::endl;
		std::cout << std::left << std::setfill(' ') << std::setw(10) << _paramArray[threadID][0] << "," << _paramArray[threadID][1] << "," << _paramArray[threadID][2] << "," << _paramArray[threadID][3] << "," << _paramArray[threadID][4] << "," << _paramArray[threadID][5] << "," << _paramArray[threadID][6] << "," << _paramArray[threadID][7] << "," << _paramArray[threadID][8] << std::setw(10) << "Residual: " << residual << std::endl;
